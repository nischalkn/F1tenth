...
float ACCEL_X_MIN = -301;//-250;
float ACCEL_X_MAX = 276; // 250;
float ACCEL_Y_MIN = -290;// -250;
float ACCEL_Y_MAX = 300;// 250;
float ACCEL_Z_MIN = -294; // -250;
float ACCEL_Z_MAX = 228;//250;
...
float GYRO_AVERAGE_OFFSET_X = -13.24;//0.0;
float GYRO_AVERAGE_OFFSET_Y = -30.01;//0.0;
float GYRO_AVERAGE_OFFSET_Z = -3.35;//0.0;
